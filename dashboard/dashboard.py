...
# Load data
all_data = pd.read_csv(r"E:\LASKAR AI\proyek analis data\dashboard\main_datas.csv")
...
st.sidebar.image(r'E:\LASKAR AI\proyek analis data\dashboard\foto-ecommerce.jpg', use_column_width=True)
